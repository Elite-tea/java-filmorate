...
CREATE TABLE IF NOT EXISTS directors (
    directors_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    directors_name VARCHAR NOT NULL UNIQUE
);

CREATE TABLE IF NOT EXISTS film_directors (
    directors_id INTEGER REFERENCES directors (directors_id) ON DELETE CASCADE,
    film_id BIGINT NOT NULL REFERENCES film (film_id) ON DELETE CASCADE,
    PRIMARY KEY (directors_id, film_id)
);